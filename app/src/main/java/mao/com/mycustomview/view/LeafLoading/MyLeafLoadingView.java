package mao.com.mycustomview.view.LeafLoading;
...
/**
 * Created by 毛麒添 on 2017/10/27 0027.
 * 落叶效果加载进度条
 */

public class MyLeafLoadingView extends View {
    ...
    private Bitmap mOuterBitmap;//Loading 边框
    ...
    public MyLeafLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initPaint() {
        ...
        mBitmapPaint.setAntiAlias(true);//防止边缘的锯齿
        mBitmapPaint.setFilterBitmap(true);//滤波，也是防止边缘的锯齿的一种
        mBitmapPaint.setDither(true);//设置防抖动,让图片看起来柔和一些
        //白色区域画笔
    ...
    private void drawLeafs(Canvas canvas) {
        ...
        for (int i = 0; i < mLeafInfos.size(); i++) {//根据产生的叶子数进行绘制
    ...
    private class LeafFactory {
        ...
        public Leaf generateLeaf(){
            Leaf leaf=new Leaf();
            int randomType = random.nextInt(3); // 1--3 随机
            // 随时类型－ 随机振幅
        ...
        // 根据传入的叶子数量产生叶子信息
        public List<Leaf> generateLeafs(int maxLeafs) {
